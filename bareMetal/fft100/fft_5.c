...
int main() {
	...
	while(1) {
		...
		printf("Inicio do processamento do frame_5: %d", i++);

		msg = Receive();
		logN = msg.msg[0];

		printf("Recebeu logN_5 %d", logN);
		...
		printf("Recebeu imag_5");
		printf("Inicio da FFT_5");
		...
		printf("Envio completo do Frame_5");
	}

	printf("Fim da Aplicacao FFT_5");
