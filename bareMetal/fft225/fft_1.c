...
int main() {
	...
	while(1) {
		...
		printf("Inicio do processamento do frame_1: %d", i++);

		msg = Receive();
		logN = msg.msg[0];

		printf("Recebeu logN_1 %d", logN);
		...
		printf("Recebeu imag_1");
		printf("Inicio da FFT_1");
		...
		printf("Envio completo do Frame_1");
	}

	printf("Fim da Aplicacao FFT_1");
