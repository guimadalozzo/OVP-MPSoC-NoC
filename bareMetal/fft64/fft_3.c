...
int main() {
	...
	while(1) {
		...
		printf("Inicio do processamento do frame_3: %d", i++);

		msg = Receive();
		logN = msg.msg[0];

		printf("Recebeu logN_3 %d", logN);
		...
		printf("Recebeu imag_3");
		printf("Inicio da FFT_3");
		...
		printf("Envio completo do Frame_3");
	}

	printf("Fim da Aplicacao FFT_3");
