...
def createFront():
	...
	frontFile.write('\nint main() {\n')
	frontFile.write('\n\tMemoryWrite(INITIALIZE_ROUTER, 11);\n')
	...
	frontFile.write('\n\t\tprintf("\nFront recebeu o resultado da fft_2");\n')
	frontFile.write('\n\t\t}\n')
...
def createFFT():
	...
	fftFile.write('	MemoryWrite(INITIALIZE_ROUTER, 1);\n')
	...
	fftFile.write('			break;\n')
	fftFile.write('\n')
	fftFile.write('		printf("Inicio do processamento do frame_0: %d", i++);\n')
	fftFile.write('\n')
	fftFile.write('		msg = Receive();\n')
	fftFile.write('		logN = msg.msg[0];\n')
	fftFile.write('\n')
	fftFile.write('		printf("Recebeu logN_0 %d", logN);\n')
	fftFile.write('\n')
	...
	fftFile.write('\n')
	fftFile.write('		printf("Recebeu real_0");\n')
	fftFile.write('\n')
	...
	fftFile.write('\n')
	fftFile.write('		printf("Recebeu imag_0");\n')
	fftFile.write('		printf("Inicio da FFT_0");\n')
	fftFile.write('\n')
	fftFile.write('		FFT(logN, real, im);\n')
	fftFile.write('\n')
	fftFile.write('		printf("Fim da FFT_0");\n')
	fftFile.write('\n')
	fftFile.write('		//Assuming that msg size is seted\n')
	fftFile.write('		for (k=0; k<128; k++)\n')
	fftFile.write('			msg.msg[k] = real[k];\n')
	fftFile.write('		Send(msg, front_0);\n')
	fftFile.write('\n')
	fftFile.write('		for (k=0; k<128; k++)\n')
	fftFile.write('			msg.msg[k] = im[k];\n')
	fftFile.write('		Send(msg, front_0);\n')
	fftFile.write('\n')
	fftFile.write('		printf("Envio completo do Frame_0");\n')
	fftFile.write('	}\n')
	fftFile.write('\n')
	fftFile.write('	printf("Fim da Aplicacao FFT_0");\n')
	fftFile.write('	MemoryWrite(END_SIM, 1);\n')
	fftFile.write('\n')
...
try:
	frontFile = open(nomeFront+".c", "w")
	createFront();
	frontFile.close()

	fftFile = open(nomeFFT+".c", "w")
	createFFT();
	fftFile.close()
